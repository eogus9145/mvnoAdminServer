...
public class HTMLTagFilterRequestWrapper extends HttpServletRequestWrapper {
	...
	static private String[] whiteListTag = { "<p>","</p>","<br />","<strong>","</strong>","<ul>","</ul>","<li>","</li>","<em>","</em>","<table>","</table>","<tbody>","</tbody>","<tr>","</tr>","<td>","</td>"};
	...
	private String getSafeParamData(String value) {
		...
		String newValue = strBuff.toString();
		newValue = newValue.replace("/..", "test");// 파일다운로드 탈취 예방
